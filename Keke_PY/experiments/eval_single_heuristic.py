...
def eval_single_heuristic(heur: Heuristic, agent_factory: AgentFromPolicy = HeuristicGuidedSearch.GuidedSearchFactory()) -> Dict[int, float]:
    ...
    test_problem = KekeProblem.default_problem(representation, multiprocessing.Pool(), level_sources=["./json_levels/full_biy_LEVELS.json"], agent_factory=agent_factory)
