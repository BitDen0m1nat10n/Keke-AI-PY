...
#SBATCH --output=TreeVsLinear_TimeBased_50MoreGens_60sec_%A_%a-out.txt   # Logdatei für den merged STDOUT/STDERR output (%A wird durch slurm Job-ID ersetzt und %a durch den Array Index)
