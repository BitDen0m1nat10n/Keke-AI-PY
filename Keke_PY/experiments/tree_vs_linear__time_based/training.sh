...
#SBATCH --output=TreeVsLinear_TimeBased_50Gens_60sec_experimental_more_binary_heuristics_depth5_%A_%a-out.txt   # Logdatei für den merged STDOUT/STDERR output (%A wird durch slurm Job-ID ersetzt und %a durch den Array Index)
